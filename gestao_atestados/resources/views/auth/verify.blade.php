                ...
                <div class="card-body">
                    @if (session('resent'))
                        <div class="alert alert-success" role="alert">
                            {{ __('Um link de verificação fresco foi enviado para o seu endereço de email.') }}
                        </div>
                    @endif

                    {{ __('Antes de prosseguir, por favor, verifique seu email em busca de um link de verificação.') }}
